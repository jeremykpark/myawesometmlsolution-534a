Scaling [myawesometmlsolution-534a] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolution-534a] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolution-534a.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolution-534a.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolution-534a.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolution-534a.yml

myawesometmlsolution-534a.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolution-534a.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolution-534a.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolution-534a
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolution-534a
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolution-534a
             image: jeremykpark/myawesometmlsolution-534a-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: SOLUTIONNAME
               value: 'myawesometmlsolution-534a'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolution-534a'
             - name: GITUSERNAME
               value: 'jeremykpark'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolution-534a-visualization-service
       labels:
         app: myawesometmlsolution-534a-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-534a 60949:60949

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:60949/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolution-534a.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolution-534a.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolution-534a.yml
