...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/jeremykpark/tml-raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=9010  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='jeremykpark'  \-\-env DOCKERUSERNAME='jeremykpark'  \-\-env MQTTUSERNAME='tsstestcluser234'  \-\-env KAFKACLOUDUSERNAME='KV4GV4NF2H33GAPT'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=34857, VIPERHOST_PREPOCESS=127.0.0.1, VIPERPORT_PREPROCESS=44563, VIPERHOST_PREPOCESS2=127.0.0.1, VIPERPORT_PREPROCESS2=43673, VIPERHOST_PREPOCESS_PGPT=127.0.0.1, VIPERPORT_PREPROCESS_PGPT=37641, VIPERHOST_ML=127.0.0.1, VIPERPORT_ML=42065, VIPERHOST_PREDCT=127.0.0.1, VIPERPORT_PREDICT=36823, HPDEHOST=127.0.0.1, HPDEPORT=36691, HPDEHOST_PREDICT=127.0.0.1, HPDEPORT_PREDICT=38033

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7635-myawesometmlsolution-534a,solution_preprocessing_dag-myawesometmlsolution-534a, python-preprocess-1932-myawesometmlsolution-534a,solution_preprocessing_dag-myawesometmlsolution-534a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
