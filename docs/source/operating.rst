[myawesometmlsolution-534a] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-534a] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-534a] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/jeremykpark/tml-raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45353  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='jeremykpark'  \-\-env DOCKERUSERNAME='jeremykpark'  \-\-env MQTTUSERNAME='tsstestcluser234'  \-\-env KAFKACLOUDUSERNAME='KV4GV4NF2H33GAPT'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
.. code-block::
   ...
   docker run -d -p 56195:56195 -p 54695:54695 -p 60949:60949 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=56195 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          -v /your_localmachine/foldername:/rawdata:z \
          --env CHIP=arm64 \
          --env SOLUTIONAIRFLOWPORT=54695 \
          --env SOLUTIONVIPERVIZPORT=60949 \
...
[myawesometmlsolution-534a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/jeremykpark/tml-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-534a
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-534a
...
.. important::
   VIPERHOST_PRODUCE=127.0.0.1, VIPERPORT_PRODUCE=56195, VIPERHOST_PREPOCESS=127.0.0.1, VIPERPORT_PREPROCESS=42747, VIPERHOST_PREPOCESS2=127.0.0.1, VIPERPORT_PREPROCESS2=40137, VIPERHOST_PREPOCESS_PGPT=127.0.0.1, VIPERPORT_PREPROCESS_PGPT=42055, VIPERHOST_ML=127.0.0.1, VIPERPORT_ML=46409, VIPERHOST_PREDCT=127.0.0.1, VIPERPORT_PREDICT=41275, HPDEHOST=127.0.0.1, HPDEPORT=33153, HPDEHOST_PREDICT=127.0.0.1, HPDEPORT_PREDICT=37351

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7868-myawesometmlsolution-534a,solution_preprocessing_dag-myawesometmlsolution-534a, python-preprocess-6118-myawesometmlsolution-534a,solution_preprocessing_dag-myawesometmlsolution-534a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
